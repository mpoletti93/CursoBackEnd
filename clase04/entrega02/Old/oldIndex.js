...
async deleteById(id) {
    ...
    console.log(`Error: ${error.code} Hubo un error tratando de eliminar el producto con id (${id})`);
    }
}
...
async deleteAll() {
    ...
    console.log(`Error:${error.code} cuando intenta eliminar todos los archivos`);
    }
    }
}
